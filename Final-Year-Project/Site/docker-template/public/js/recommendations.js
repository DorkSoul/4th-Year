...
// Get DOM elements for recommendations and user suggestions
...
document.addEventListener("DOMContentLoaded", function () {
  // Get DOM elements for the stats popup and close button
  var statsPopup = document.getElementById("stats-popup");
  var closeButton = document.querySelector(".button-2");

  // Function to toggle the visibility of the stats popup
  ...
  // Function to fill the stats popup with subscription data
  ...
  // Function to find a subscription object by ID
  function getSubscriptionById(id) {
    return subscriptions.find(sub => sub.id === id);
  }

  // Add event listener to the close button to close the stats popup
